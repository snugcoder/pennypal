...
class PortfolioReport(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, portfolio_id, type, status, created_date, *args, **kwargs):  # noqa: E501
        """PortfolioReport - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, portfolio_id, type, status, created_date, *args, **kwargs):  # noqa: E501
        """PortfolioReport - a model defined in OpenAPI
