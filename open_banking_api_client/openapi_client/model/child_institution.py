...
class ChildInstitution(ModelNormal):
    ...
    attribute_map = {
        'rssd': 'rssd',  # noqa: E501
        'parent_rssd': 'parentRSSD',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, rssd, parent_rssd, name, institution_id, *args, **kwargs):  # noqa: E501
        """ChildInstitution - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, rssd, parent_rssd, name, institution_id, *args, **kwargs):  # noqa: E501
        """ChildInstitution - a model defined in OpenAPI
