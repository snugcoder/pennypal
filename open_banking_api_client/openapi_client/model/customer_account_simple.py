...
class CustomerAccountSimple(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, account_number_display, name, type, status, customer_id, institution_id, created_date, currency, institution_login_id, display_position, *args, **kwargs):  # noqa: E501
        """CustomerAccountSimple - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            aggregation_success_date (int): A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).. [optional]  # noqa: E501
            aggregation_attempt_date (int): A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).. [optional]  # noqa: E501
            parent_account (str): An account ID. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, account_number_display, name, type, status, customer_id, institution_id, created_date, currency, institution_login_id, display_position, *args, **kwargs):  # noqa: E501
        """CustomerAccountSimple - a model defined in OpenAPI
