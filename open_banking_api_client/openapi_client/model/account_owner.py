...
class AccountOwner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, owner_name, owner_address, *args, **kwargs):  # noqa: E501
        """AccountOwner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            as_of_date (int): A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, owner_name, owner_address, *args, **kwargs):  # noqa: E501
        """AccountOwner - a model defined in OpenAPI
