...
class LiteConnectParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, partner_id, customer_id, institution_id, *args, **kwargs):  # noqa: E501
        """LiteConnectParameters - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, partner_id, customer_id, institution_id, *args, **kwargs):  # noqa: E501
        """LiteConnectParameters - a model defined in OpenAPI
