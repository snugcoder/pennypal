...
class VOIETXVerifyReportAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, number, name, type, aggregation_status_code, transactions, *args, **kwargs):  # noqa: E501
        """VOIETXVerifyReportAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, number, name, type, aggregation_status_code, transactions, *args, **kwargs):  # noqa: E501
        """VOIETXVerifyReportAccount - a model defined in OpenAPI
