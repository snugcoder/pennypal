...
class NewConsumer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, first_name, last_name, address, city, state, zip, phone, ssn, birthday, *args, **kwargs):  # noqa: E501
        """NewConsumer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, last_name, address, city, state, zip, phone, ssn, birthday, *args, **kwargs):  # noqa: E501
        """NewConsumer - a model defined in OpenAPI
