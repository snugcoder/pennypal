...
class AppStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pre_app_id': (str,),  # noqa: E501
            'app_name': (str,),  # noqa: E501
            'submitted_date': (int,),  # noqa: E501
            'modified_date': (int,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'note': (str,),  # noqa: E501
            'application_id': (str,),  # noqa: E501
            'scopes': (str,),  # noqa: E501
            'institution_details': ([AppFinancialInstitutionStatus],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'institution_details': 'institutionDetails',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, partner_id, pre_app_id, app_name, submitted_date, modified_date, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            note (str): A note on the registration. Typically used to indicate reasons for rejected apps.. [optional]  # noqa: E501
            application_id (str): `applicationId` value returned from the Get App Registration Status API and the partner assign the customers to. This cannot be changed once set. Only applicable in cases of partners with multiple registered applications. If the partner only has one app, this can usually be omitted. This field is populated after the app is in a status approved.. [optional]  # noqa: E501
            scopes (str): Indicates scopes of data accessible to the app. [optional]  # noqa: E501
            institution_details ([AppFinancialInstitutionStatus]): A list of the registration status for each FI for the application. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, partner_id, pre_app_id, app_name, submitted_date, modified_date, status, *args, **kwargs):  # noqa: E501
        """AppStatus - a model defined in OpenAPI
