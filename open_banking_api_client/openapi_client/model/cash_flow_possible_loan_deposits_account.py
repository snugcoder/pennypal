...
class CashFlowPossibleLoanDepositsAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, owner_name, owner_address, name, number, type, aggregation_status_code, current_balance, available_balance, balance_date, transactions, *args, **kwargs):  # noqa: E501
        """CashFlowPossibleLoanDepositsAccount - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, owner_name, owner_address, name, number, type, aggregation_status_code, current_balance, available_balance, balance_date, transactions, *args, **kwargs):  # noqa: E501
        """CashFlowPossibleLoanDepositsAccount - a model defined in OpenAPI
