...
class ReportSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, request_id, requester_name, created_date, type, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, request_id, requester_name, created_date, type, status, *args, **kwargs):  # noqa: E501
        """ReportSummary - a model defined in OpenAPI
