...
class ReportSummaries(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'reports': ([ReportSummary],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, reports, *args, **kwargs):  # noqa: E501
        """ReportSummaries - a model defined in OpenAPI

        Args:
            reports ([ReportSummary]): Data pertaining to each report
