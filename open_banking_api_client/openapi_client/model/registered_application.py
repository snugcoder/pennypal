...
class RegisteredApplication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pre_app_id, status, *args, **kwargs):  # noqa: E501
        """RegisteredApplication - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, pre_app_id, status, *args, **kwargs):  # noqa: E501
        """RegisteredApplication - a model defined in OpenAPI
