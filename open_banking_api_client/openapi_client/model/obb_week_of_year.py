...
class ObbWeekOfYear(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, from_date, to_date, week, *args, **kwargs):  # noqa: E501
        """ObbWeekOfYear - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, from_date, to_date, week, *args, **kwargs):  # noqa: E501
        """ObbWeekOfYear - a model defined in OpenAPI
