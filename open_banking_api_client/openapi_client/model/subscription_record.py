...
class SubscriptionRecord(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, account_id, type, callback_url, signing_key, *args, **kwargs):  # noqa: E501
        """SubscriptionRecord - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, account_id, type, callback_url, signing_key, *args, **kwargs):  # noqa: E501
        """SubscriptionRecord - a model defined in OpenAPI
