...
class PayStatement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, statement, *args, **kwargs):  # noqa: E501
        """PayStatement - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, statement, *args, **kwargs):  # noqa: E501
        """PayStatement - a model defined in OpenAPI
