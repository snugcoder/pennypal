...
class Consumer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, first_name, last_name, customer_id, address, city, state, zip, phone, ssn, birthday, email, created_date, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, first_name, last_name, customer_id, address, city, state, zip, phone, ssn, birthday, email, created_date, *args, **kwargs):  # noqa: E501
        """Consumer - a model defined in OpenAPI
