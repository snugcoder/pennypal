...
class FixConnectParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, partner_id, customer_id, institution_login_id, *args, **kwargs):  # noqa: E501
        """FixConnectParameters - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, partner_id, customer_id, institution_login_id, *args, **kwargs):  # noqa: E501
        """FixConnectParameters - a model defined in OpenAPI
