...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AccountValidationAssistanceApi()
        api_instance.get_micro_deposits_details  # this is an instance of the class Endpoint
        api_instance.get_micro_deposits_details()  # this invokes api_instance.get_micro_deposits_details.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_micro_deposits_details.callable or self.callable in this class
