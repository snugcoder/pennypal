...
class CashFlowAnalyticsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_cash_flow_analytics_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/cashflow/v1/customer/{customerId}',
                'operation_id': 'generate_cash_flow_analytics',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.generate_cash_flow_analytics_fcra_endpoint = _Endpoint(
            settings={
                'response_type': (BalanceAndCashFlowAnalyticsReportAck,),
                'auth': [
                    'FinicityAppKey',
                ...
                'endpoint_path': '/analytics/cashflow/v1/customer/{customerId}/fcra',
                'operation_id': 'generate_cash_flow_analytics_fcra',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def generate_cash_flow_analytics(
        self,
        customer_id,
        balance_and_cash_flow_analytics_report_constraints,
        **kwargs
        ...
        >>> thread = api.generate_cash_flow_analytics(customer_id, balance_and_cash_flow_analytics_report_constraints, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['balance_and_cash_flow_analytics_report_constraints'] = \
            balance_and_cash_flow_analytics_report_constraints
        return self.generate_cash_flow_analytics_endpoint.call_with_http_info(**kwargs)

    def generate_cash_flow_analytics_fcra(
        self,
        customer_id,
        balance_and_cash_flow_analytics_report_constraints,
        **kwargs
        ...
        >>> thread = api.generate_cash_flow_analytics_fcra(customer_id, balance_and_cash_flow_analytics_report_constraints, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['balance_and_cash_flow_analytics_report_constraints'] = \
            balance_and_cash_flow_analytics_report_constraints
        return self.generate_cash_flow_analytics_fcra_endpoint.call_with_http_info(**kwargs)
