...
class Receiver(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, routing_number, account_number, account_type, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            memo (str): Transaction memo to be displayed for transactions. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, routing_number, account_number, account_type, name, *args, **kwargs):  # noqa: E501
        """Receiver - a model defined in OpenAPI
