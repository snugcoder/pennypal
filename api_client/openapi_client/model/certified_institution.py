...
class CertifiedInstitution(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'rssd': (int,),  # noqa: E501
            'child_institutions': ([ChildInstitution],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'rssd': 'rssd',  # noqa: E501
        'child_institutions': 'childInstitutions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, trans_agg, ach, state_agg, voi, voa, aha, avail_balance, account_owner, student_loan_data, loan_payment_details, *args, **kwargs):  # noqa: E501
        """CertifiedInstitution - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            rssd (int): The RSSD ID is a unique identifier assigned to financial institutions by the Federal Reserve. While the length of the RSSD ID varies by institution, it cannot exceed 10 numerical digits.. [optional]  # noqa: E501
            child_institutions ([ChildInstitution]): An array of child financial institutions. [optional]  # noqa: E501
        """
        ...
        self.student_loan_data = student_loan_data
        self.loan_payment_details = loan_payment_details
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, trans_agg, ach, state_agg, voi, voa, aha, avail_balance, account_owner, student_loan_data, loan_payment_details, *args, **kwargs):  # noqa: E501
        """CertifiedInstitution - a model defined in OpenAPI
