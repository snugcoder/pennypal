...
class PayrollData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ssn, dob, *args, **kwargs):  # noqa: E501
        """PayrollData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            report_id (str): The report ID of the original payroll report for refresh use cases. If used, only the employment records from the original report will be included in the refreshed report response.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ssn, dob, *args, **kwargs):  # noqa: E501
        """PayrollData - a model defined in OpenAPI
