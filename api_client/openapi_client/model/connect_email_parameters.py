...
class ConnectEmailParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, partner_id, customer_id, consumer_id, email, *args, **kwargs):  # noqa: E501
        """ConnectEmailParameters - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, partner_id, customer_id, consumer_id, email, *args, **kwargs):  # noqa: E501
        """ConnectEmailParameters - a model defined in OpenAPI
