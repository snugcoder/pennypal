...
class ReportIncomeEstimate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, net_annual, projected_net_annual, estimated_gross_annual, projected_gross_annual, *args, **kwargs):  # noqa: E501
        """ReportIncomeEstimate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, net_annual, projected_net_annual, estimated_gross_annual, projected_gross_annual, *args, **kwargs):  # noqa: E501
        """ReportIncomeEstimate - a model defined in OpenAPI
