...
class TransactionsReportAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TransactionsReportAccount - a model defined in OpenAPI
