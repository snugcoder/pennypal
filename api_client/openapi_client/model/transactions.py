...
class Transactions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, found, displaying, more_available, from_date, to_date, sort, transactions, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            transactions ([Transaction]): The array of transactions
    ...
    @convert_js_args_to_python_args
    def __init__(self, found, displaying, more_available, from_date, to_date, sort, transactions, *args, **kwargs):  # noqa: E501
        """Transactions - a model defined in OpenAPI
