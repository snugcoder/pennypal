...
class CreatedTestTxPushTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_date, *args, **kwargs):  # noqa: E501
        """CreatedTestTxPushTransaction - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_date, *args, **kwargs):  # noqa: E501
        """CreatedTestTxPushTransaction - a model defined in OpenAPI
