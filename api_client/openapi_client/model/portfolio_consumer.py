...
class PortfolioConsumer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, first_name, last_name, customer_id, ssn, birthday, *args, **kwargs):  # noqa: E501
        """PortfolioConsumer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, first_name, last_name, customer_id, ssn, birthday, *args, **kwargs):  # noqa: E501
        """PortfolioConsumer - a model defined in OpenAPI
